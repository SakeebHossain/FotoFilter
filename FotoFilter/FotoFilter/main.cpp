...
int load(int num)
{
    for(int constant = 1; constant <= num; constant++)
    {
        ...
        Mat image;
        string vidPath = "/Users/232878/Desktop/Development/" + to_string(constant) + ".jpg";
...
/*
    ...
    if (argc != 2)
    {
        cout << "Parameters are incorrect, dawg" << endl;
    }
...
*/
    ...
    for (count = 1; count < cap.get(CV_CAP_PROP_FRAME_COUNT); count++)
    {
        ...
        string filePath = argv[2] + to_string(count) + ".jpg";
        imwrite(filePath,frame,compression_params);
    }
    for (anotherCount = 1; anotherCount < cap.get(CV_CAP_PROP_FRAME_COUNT) - 1; anotherCount++)
    {
        string path = "/Users/232878/Desktop/Development/" + to_string(anotherCount) + ".jpg";
        firstFrame = imread(path);
        
        string nextPath = "/Users/232878/Desktop/Development/" + to_string(anotherCount + 1) + ".jpg";
